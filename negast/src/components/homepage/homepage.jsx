    ...
    <>
      ...
      <div id="a_stats">
        <div>
          ...
          <p>
            Online E-commerce giants are taking over more than 40% of the market
            combined.
          </p>
        </div>
        <div>
          ...
          <p>
            As per IBIS forecast research the online revenue will increase
            around 9% per year for the next 5 years. In that sense the online
            market will touch 60-70% by 2024
          </p>
        </div>
        <div>
          ...
          <h2>Market Down</h2>
          <p>
            As per the calculation if you are selling 100 products a month then
            it would be decreased around 30-40 products a month.
          </p>
        </div>
      </div>
      ...
      <div id="a_solution_container">
        ...
        <div id="a_solution">
          ...
          <div id="a_solution_text">
            <h2>Introduction</h2>
            <p>
              Negast is designed in such a way that it creates eagerness among
              the consumers & never let them buy outside the city. Because every
              seller has a potential to deliver the goods to their consumers at
              the best price with good service.
            </p>
          </div>
        </div>
      </div>
